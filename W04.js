...
var App = {
  ...
  getFirstName: function () {
    let answer = prompt("Enter the name of the organization attending the event","Northwest Missouri");
    if (answer != null) {
  ...
  getLastName: function () {
    let answer = prompt("What is the type of sport your looking for","basketball");
    if (answer != null) {
  ...
  getWidth: function () {
    let answer = prompt("What is the number of rows the organization wants to reserve",5);
    if (answer != null) {
  ...
  getLength: function () {
    let answer = prompt("What is the number of seats per row the organization wants to reserve",10);
    if (answer != null) {
